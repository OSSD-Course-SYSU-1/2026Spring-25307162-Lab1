...
class CalculateUtil {
    ...
    calResult(arg1: string, arg2: string, symbol: string): string {
        ...
        switch (symbol) {
            ...
            case SymbolicEnumeration.POW:
                ...
                break;
            case SymbolicEnumeration.LOG:
                result = this.logarithm(arg1, arg2);
                break;
            default:
                break;
        }
    ...
    /**
     * Logarithm operation.
     * log_base(arg1) = arg2 means base^arg2 = arg1
     * So we calculate: log(arg1) / log(arg2) where arg2 is the base
     *
     * @param arg1 The number.
     * @param base The base of logarithm.
     * @return Logarithm result.
     */
    logarithm(arg1: string, base: string): number {
        let num = Number(arg1);
        let baseNum = Number(base);
